...
public class DibiApiController implements DibiApi {
	...
	if (scelta.equals("Email") || scelta.equals("Numero di Telefono") || scelta.equals("Pagina Web del Docente") || scelta.equals("Contatti")) {			
							     ...
							     if (newStr.length>3) {
							    	 ...
							    	 if(unito1.equals(cognome_prof)|| unito2.equals(cognome_prof) || unito3.equals(cognome_prof)) {
							    		 if(scelta.equals("Email")) {
												...
												answerlist.add(answer);
											}else if (scelta.equals("Contatti")) {
		...
		switch (scelta) {
					...
					case "Finestra Temporale Accettazione richieste Tirocinio":{
						...
						try {
							HtmlPage page1 = client.getPage(baseUrl);
						    HtmlElement finestra1 = page1.getFirstByXPath("//*[@id=\"parent-fieldname-text-6af98676d13d43c88ab06b5a8342a1ac\"]/div[2]/strong");
		...
		case "Segreteria Didattica":{
			...
			try {
				...
				HtmlElement segreteria_did = page1.getFirstByXPath("//*[@id=\"portletwrapper-706c6f6e652e7269676874636f6c756d6e0a636f6e746578740a2f756e696261342f726963657263612f646970617274696d656e74692f696e666f726d61746963612f646970617274696d656e746f2d64692d696e666f726d61746963610a7370617a696f2d73747564656e7469\"]/dl/dd/p[8]");
		...
		case "Pratiche Studenti Stranieri":{
			...
			try {
				...
				HtmlElement stud_s = page1.getFirstByXPath("//*[@id=\"portletwrapper-706c6f6e652e7269676874636f6c756d6e0a636f6e746578740a2f756e696261342f726963657263612f646970617274696d656e74692f696e666f726d61746963612f646970617274696d656e746f2d64692d696e666f726d61746963610a7370617a696f2d73747564656e7469\"]/dl/dd/p[9]");
		...
		case "Segreteria Orientamento, Tirocinio e Job Placement":{
			...
			try {
				...
				HtmlElement orient = page1.getFirstByXPath("//*[@id=\"portletwrapper-706c6f6e652e7269676874636f6c756d6e0a636f6e746578740a2f756e696261342f726963657263612f646970617274696d656e74692f696e666f726d61746963612f646970617274696d656e746f2d64692d696e666f726d61746963610a7370617a696f2d73747564656e7469\"]/dl/dd/p[10]");
	...
	public ResponseEntity<FormFieldValuesResponse> values(
		...
		if (accept != null && accept.contains("application/json")) {
			try {
				...
				if (data.getFieldName().equals("Cognome Docente")) {
					String baseUrl="https://www.uniba.it/ricerca/dipartimenti/informatica/dipartimento/personale/docenti-2";
					String baseUrl2="https://www.uniba.it/ricerca/dipartimenti/informatica/dipartimento/personale/tecniciamministrativi";
					WebClient client = new WebClient();
					client.getOptions().setCssEnabled(false);
					...
					s.add(nome2);
						...
						for (String nome : s) {
							String[] newStr = nome.split("\\s+");
							if(newStr.length==2) {
								nome=newStr[0]+" "+newStr[1];
							}else if(newStr.length==3) {
								char p = newStr[1].charAt(1);
								...
								char p = newStr[1].charAt(1);
								char d = newStr[2].charAt(1);
								if (Character.isUpperCase(p)&& Character.isUpperCase(d)) {
									nome =newStr[0]+newStr[1]+newStr[2];
								}else if(Character.isUpperCase(p) && Character.isLowerCase(d)) {
									nome =newStr[0]+newStr[1];
						    ...
						    if(nome.equals("d'AMATO")) {
						    	values.add(new FormAdmissibileValue().name(nome).alias("damato").alias("d amato"));
								response.setValues(values);	
								
						    } else if(nome.equals("DeGEMMIS")) {
							values.add(new FormAdmissibileValue().name(nome).alias("de gemmis"));
							response.setValues(values);
						    } else if(nome.equals("DECAROLIS")) {
								values.add(new FormAdmissibileValue().name(nome).alias("de carolis"));
								response.setValues(values);	
						}else {
							values.add(new FormAdmissibileValue().name(nome));
							response.setValues(values);	
						}
